          ...
          <TableBody>
            {programs.map((program) => {
              ...
              if (program["Status / Information"] === "This course has started") {
                ...
                style = "border rounded p-1 text-orange-700 border-orange-700 text-xs md:text-sm";
              } else if (program["Status / Information"] === "This course is open for registration") {
                status = "Open for Registration";
                style = "border rounded p-1 text-lime-600 border-lime-600 text-xs md:text-sm";
              }
              return (
                <TableRow
